...
const Header = () => {
  ...
  if (curr_user !== null && curr_user !== "") {
    home_page_items = <div classNameName="input_panel">
      <text classNameName='username'>{sessionStorage.getItem("username")}</text>
      <a classNameName="nav_item" href="/djangoapp/logout" onClick={logout}>Logout</a>
    </div>
  }
